...
public class AdminEvent {
    ...
    /**
     * Returns the type of the affected {@link org.keycloak.events.admin.ResourceType} for this {@link org.keycloak.events.admin.AdminEvent}, e.g. {@link org.keycloak.events.admin.ResourceType#USER USER}, {@link org.keycloak.events.admin.ResourceType#GROUP GROUP} etc.
     *
     * @return
     */
    ...
    /**
     * Returns the type as string. Custom resource types with values different from {@link org.keycloak.events.admin.ResourceType} are possible. In this case {@link #getResourceType()} returns <code>CUSTOM</code>.
     *
     * @return
     */
    ...
    /**
     * Setter for custom resource types with values different from {@link org.keycloak.events.admin.ResourceType}.
     */
