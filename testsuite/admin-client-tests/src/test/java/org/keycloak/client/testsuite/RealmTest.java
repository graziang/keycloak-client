...
public class RealmTest extends AbstractAdminClientTest {
    ...
    public void getRealms() {
        ...
        Assert.assertNames(realms, "master", REALM_NAME);
    }
    ...
    public void createRealmEmpty() {
        ...
        Assert.assertNames(adminClient.realms().findAll(), "master", REALM_NAME, "new-realm");
        ...
        Assert.assertNames(adminClient.realms().findAll(), "master", REALM_NAME);
    }
    ...
    public void createRealmWithValidConsoleUris() throws Exception {
        ...
        Assert.assertNames(adminClient.realms().findAll(), "master", REALM_NAME, realmNameWithSpaces);
...
//        RealmRepresentation rep = RealmBuilder.create().build();
